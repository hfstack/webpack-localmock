(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.localmock = factory());
        ...
        return regenerator.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                rqPath = urlFormat(req.path, config);
                ...
                if (fs$1.existsSync(JSFilePath)) {
                  params = req.path.match("/".concat(placeholder, "\\w*/g"));

                  require(JSFilePath)(req, res, params && params.length ? params[0] : '');
                } else if (fs$1.existsSync(JSONFilePath)) {
                  file = fs$1.readFileSync(JSONFilePath);
                  setTimeout(function () {
                    res.json(JSON.parse(file));
                  }, 200);
                } else {
                  writeFile(JSONFilePath, JSON.stringify({
                    code: 0,
                    message: '成功',
                    data: null
                  }));
        ...
        return regenerator.wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                url = req.query.url;
                data = fs$1.readFileSync("".concat(config.mockDir, "/").concat(config.proxyToken, "/").concat(url));
                res.json({
                  code: 0,
                  message: '成功',
                  data: data.toString()
