...
var getJsonFiles = function getJsonFiles(jsonPath) {
  var jsonFiles = [];
...
var writeFile = function writeFile(path, contents, cb) {
...
var mock = function mock(option) {
  ...
  app.all("/".concat(proxyToken, "/*"), /*#__PURE__*/function () {
    var _ref = asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee(req, res) {
      var rqPath, JSFilePath, JSONFilePath, params, file;
      return regenerator.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              rqPath = util.urlFormat(req.path, config);
              JSFilePath = path.join(__dirname, "../".concat(mockDir, "/"), "".concat(rqPath, ".js"));
              JSONFilePath = path.join(__dirname, "../".concat(mockDir, "/"), "".concat(rqPath, ".json"));

              if (fs.existsSync(JSFilePath)) {
                params = req.path.match("/".concat(placeholder, "\\w*/g"));
                commonjsRequire()(req, res, params && params.length ? params[0] : '');
              } else if (fs.existsSync(JSONFilePath)) {
                file = fs.readFileSync(JSONFilePath);
                setTimeout(function () {
  ...
  app.get('/apimock/urls', /*#__PURE__*/function () {
    var _ref3 = asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee3(req, res) {
  ...
  app.get('/apimock/json', /*#__PURE__*/function () {
    var _ref4 = asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee4(req, res) {
      var url, data;
      return regenerator.wrap(function _callee4$(_context4) {
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              url = req.query.url;
              data = fs.readFileSync("mock/api/".concat(url));
              res.json({
                code: 0,
                message: '成功',
                data: data.toString()
        ...
        while (1) {
          switch (_context5.prev = _context5.next) {
            case 0:
              ...
              fs.writeFileSync("".concat(mockDir, "/").concat(proxyToken, "/").concat(url), json);
              res.json({
                code: 0,
                message: '成功',
                data: null
      ...
      return regenerator.wrap(function _callee6$(_context6) {
        while (1) {
          switch (_context6.prev = _context6.next) {
            case 0:
              _req$body2 = req.body, url = _req$body2.url, json = _req$body2.json;
              realUrl = util.urlFormat(url, config);

              if (realUrl.indexOf('.json') === -1) {
                realUrl += '.json';
              }

              fs.writeFileSync("".concat(mockDir, "/").concat(proxyToken, "/").concat(realUrl), json);
              res.json({
                code: 0,
                message: '成功',
                data: null
...
var getNetworkIp = function getNetworkIp() {
